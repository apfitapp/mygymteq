...
export class NotificationService {
  ...
  /**
   * Generates a direct WhatsApp Click-to-Chat URL (wa.me)
   * Automatically normalizes 10-digit Indian mobile numbers with +91 country code.
   */
  ...
  private buildMessage(payload: NotificationPayload): string {
    switch (payload.type) {
      case 'WELCOME':
        return `Hello ${payload.recipientName}! Welcome to ${this.gymName}. Your Member ID is ${payload.params.memberCode || 'N/A'}. We are thrilled to have you with us! 💪`;
      ...
      case 'EXPIRY_REMINDER':
        return `Hi ${payload.recipientName}, your membership at ${this.gymName} is expiring on ${payload.params.expiryDate}. Please renew to keep achieving your fitness goals without interruption! 🏋️`;
